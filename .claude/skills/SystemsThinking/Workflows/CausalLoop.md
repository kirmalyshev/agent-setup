...
To render a CLD as an actual diagram, ask for a Mermaid flowchart: the variables
as nodes, each arrow labelled with its polarity, and R1/B1 marked at the centre
of each loop.
...
- Renderable as a Mermaid diagram if a picture helps.
