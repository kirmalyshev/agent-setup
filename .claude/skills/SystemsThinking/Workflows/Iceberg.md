...
2. **Automatically** when a recurring-problem signal shows up in the work you are already doing
...
- Output informs your acceptance criteria — structural ones, not just symptom ones.
